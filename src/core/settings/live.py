...
TENANTS[NEWS]['QUALTRICS_SURVEY_ID'] = 'SV_elGBArRfIATLYwt2'
TENANTS[RETAIL]['QUALTRICS_SURVEY_ID'] = 'SV_abpqjuBRjJ9iy6F'
...
LIVE_DOMAIN = 'digitalmaturitybenchmark.withgoogle.com'
