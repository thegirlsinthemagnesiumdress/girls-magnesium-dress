...
DIMENSION_SIDEPANEL_DESCRIPTIONS = {
    ...
    DIMENSION_2: 'The extent to which IT teams are supported by a mandate from leadership to migrate to the cloud, and the degree in which the teams themselves are cross-functional, collaborative, and self-motivated.',
    DIMENSION_3: 'The extent to which cloud-native services are used that reduce operational overhead and automate manual processes and policies.',
    DIMENSION_4: 'The capability to protect services from unauthorized and inappropriate access with a multilayered, identity-centric security model.',
}
