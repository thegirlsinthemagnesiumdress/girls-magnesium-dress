...
DIMENSION_HEADER_DESCRIPTIONS = {
    DIMENSION_LEARN: 'Your organization’s ability to continuously learn is determined by your efforts to upskill your IT staff while also taking advantage of the experiences shared by third-party contractors and partners. This two-pronged approach ensures that you apply cloud computing best practices idiomatically to Google Cloud Platform (or any other public cloud provider), tailored to your business needs and without having to climb the steep learning curve of doing things for the first time.<br>Your staff will be more familiar with your organization’s unique idiosyncrasies and understand its technical and cultural nuances, while supporting third parties will have the experience of having completed multiple prior cloud migrations across a broad spectrum of customer solutions.',
    DIMENSION_LEAD: 'The effectiveness of your organization’s cloud adoption is determined by the visibility and value of the mandate issued top-down from your sponsors (which include C-level executives as well as middle management and team leaders) and the motivational momentum generated bottom-up from your teams’ cross-functional collaboration. These two counterparts together are responsible for clearly articulating objectives, making informed decisions, and executing them in concert with multiple functions.<br>Sponsors control which resources are allocated to your organization’s cloud adoption efforts and bring stakeholders from different business functions and reporting lines together. However, they must ultimately rely on an agile and cross-functional group of cloud early adopters to practically implement their strategy.',
    DIMENSION_SCALE: 'Your organization’s ability to scale in the cloud is determined by the extent to which you abstract away your infrastructure with managed and serverless cloud services, as well as the quality of your CI/CD process chain and the programmable infrastructure code that runs through it.<br>Because everything is managed via an API, automation can pay greater dividends in the cloud than in any other environment. Not only does it reduce human toil and serve as automatic documentation, it is also instrumental in making change low risk and frequent - the key ingredient for innovation.',
    DIMENSION_SECURE: 'In the narrow sense, the security of your cloud estate is determined by your ability to guarantee who may perform which action on which resource (identity and access management) and your understanding of the data that needs protecting, ensuring it is appropriately catalogued, encrypted, and guarded from exfiltration, to name just a few considerations.<br>In the more holistic sense, your security posture relies on the advanced maturity of the other three cloud adoption themes: 1) continuous learning of the latest technical vulnerabilities and security best practices, 2) leading by setting measurable security objectives and rewarding a culture of blameless postmortems, 3) scaling through automation which, in turn, minimizes human error and maximizes auditability.<br>Because security is so essential and because it cuts across all dimensions and themes, it lives at the very center of the cloud adoption model.',
}

DIMENSION_LEVEL_DESCRIPTION = {
    DIMENSION_LEARN: {
        LEVEL_0: 'Upskilling is on a best-effort basis, reliant on individual self-motivation and free educational resources like online documentation and YouTube.<br>Third-party contractors and partners are relied upon to deliver essential work required to achieve the objectives set out by the business. They typically enjoy wide-ranging and ongoing privileged access to your organization’s cloud estate and serve as a first point of escalation in the event of a technical question or an operational incident.<br>You expect to be able to achieve tactical objectives with the IT staff you have and are not taking action to hire new staff with prior cloud experience.',
        LEVEL_1: 'Upskilling is on a best-effort basis, reliant on individual self-motivation and free educational resources like online documentation and YouTube.<br>Third-party contractors and partners are relied upon to deliver essential work required to achieve the objectives set out by the business. They typically enjoy wide-ranging and ongoing privileged access to your organization’s cloud estate and serve as a first point of escalation in the event of a technical question or an operational incident.<br>You expect to be able to achieve tactical objectives with the IT staff you have and are not taking action to hire new staff with prior cloud experience.',
        LEVEL_2: 'Upskilling is program managed and offered to any IT role who is directly or indirectly responsible for contributing to a successful cloud adoption. A learning plan has been published, training classes (online or offline) are offered on a regular basis, and achieving formal certification is encouraged and budgeted for.<br>Third-party contractors and partners provide subject matter expertise to fill the IT staff’s remaining knowledge gaps or where the topic is so narrow and deep that it would be unreasonable to expect your IT staff to upskill to that level. These external parties serve as a second-tier point of escalation in the event of a technical question or operational incident that cannot be answered or resolved internally within your IT staff. As such, they will typically have moderated access to the organization’s cloud estate and be authorized (and audited) to escalate their privileges in break-glass scenarios that require quick and determined intervention.<br>You are actively opening new roles and are hiring for people with prior cloud experience to complement the IT staff as it upskills itself on cloud computing best practices.<br>Each IT staff member is given a GCP sandbox project and a limited budget for them to experiment with and test new ideas.',
        LEVEL_3: 'Upskilling is program managed and offered to any IT role who is directly or indirectly responsible for contributing to a successful cloud adoption. A learning plan has been published, training classes (online or offline) are offered on a regular basis, and achieving formal certification is encouraged and budgeted for.<br>Third-party contractors and partners provide subject matter expertise to fill the IT staff’s remaining knowledge gaps or where the topic is so narrow and deep that it would be unreasonable to expect your IT staff to upskill to that level. These external parties serve as a second-tier point of escalation in the event of a technical question or operational incident that cannot be answered or resolved internally within your IT staff. As such, they will typically have moderated access to the organization’s cloud estate and be authorized (and audited) to escalate their privileges in break-glass scenarios that require quick and determined intervention.<br>You are actively opening new roles and are hiring for people with prior cloud experience to complement the IT staff as it upskills itself on cloud computing best practices.<br>Each IT staff member is given a GCP sandbox project and a limited budget for them to experiment with and test new ideas.',
        LEVEL_4: 'Upskilling is continuous and collaborative. In addition to a regular formal training program, IT teams and individual contributors host regular hackathons and tech talks to maximize knowledge sharing. Going one step further, IT staff are encouraged to demonstrate thought leadership to the industry through public blog articles and public speaking. This outreach serves a double function of challenging staff to stretch themselves and also to attract new talent to be hired.<br>You have reviewed and, where needed, redefined all roles and responsibilities to reflect the new requirements of a cloud-first IT organization.<br>Third-party contractors and partners serve primarily as staff augmentation with no privileged access and very few areas of exclusive knowledge. Most technical questions can be answered internally, and all incident response playbooks can be executed entirely in-house.',
    },
    DIMENSION_LEAD: {
        LEVEL_0: 'Sponsorship is limited to senior management from or for one line of business. Their primary contribution is delivering the mandate (“signing off”) and passing it down their reporting line to be executed upon. Sponsors only get actively involved as a final point of escalation when progress is otherwise hampered.<br>Cloud adoption progress is driven by individual contributors with a personal interest in cloud computing for their solution(s). The ability for early adopters to collaborate with other IT roles is subject to the friction of the incumbent org structure and reporting lines.<br>Because the scope is limited to the project or line of business that this team of early adopters is aligned with -- and must operate within that budget -- their output will not be embedded with central IT. Depending on the perspective, the outcome is either a “minimum viable cloud” or “cloud shadow IT”.',
        LEVEL_1: 'Sponsorship is limited to senior management from or for one line of business. Their primary contribution is delivering the mandate (“signing off”) and passing it down their reporting line to be executed upon. Sponsors only get actively involved as a final point of escalation when progress is otherwise hampered.<br>Cloud adoption progress is driven by individual contributors with a personal interest in cloud computing for their solution(s). The ability for early adopters to collaborate with other IT roles is subject to the friction of the incumbent org structure and reporting lines.<br>Because the scope is limited to the project or line of business that this team of early adopters is aligned with -- and must operate within that budget -- their output will not be embedded with central IT. Depending on the perspective, the outcome is either a “minimum viable cloud” or “cloud shadow IT”.',
        LEVEL_2: 'Sponsorship extends up to the C-level. Each manager in the reporting line has clearly defined objectives and KPIs that support the organization’s cloud adoption. Sponsors’ key contributions include actively reaching out horizontally to other IT or business functions to clear the critical path of roadblocks and visibly and continuously championing the journey.<br>Performance indicators prioritize traditional IT service-level objectives over the speed of experimentation, innovation, and recovery from failure.<br>Cloud adoption progress is driven by a dedicated cross-functional team (Center of Excellence) of advocates, working across project boundaries. All critical IT roles inside this COE are filled, for example, application architect, software or data engineer, networking engineer, and identity/directory admin, across operations, information security, and finance. Team members are committed full-time or part-time, and their job title and their personal performance indicators are updated to reflect their new responsibilities.<br>Cloud adoption may also be complemented by a dedicated technical project manager who is familiar with the IT organization, the stakeholders, and the technology landscape.',
        LEVEL_3: 'Sponsorship extends up to the C-level. Each manager in the reporting line has clearly defined objectives and KPIs that support the organization’s cloud adoption. Sponsors’ key contributions include actively reaching out horizontally to other IT or business functions to clear the critical path of roadblocks and visibly and continuously championing the journey.<br>Performance indicators prioritize traditional IT service-level objectives over the speed of experimentation, innovation, and recovery from failure.<br>Cloud adoption progress is driven by a dedicated cross-functional team (Center of Excellence) of advocates, working across project boundaries. All critical IT roles inside this COE are filled, for example, application architect, software or data engineer, networking engineer, and identity/directory admin, across operations, information security, and finance. Team members are committed full-time or part-time, and their job title and their personal performance indicators are updated to reflect their new responsibilities.<br>Cloud adoption may also be complemented by a dedicated technical project manager who is familiar with the IT organization, the stakeholders, and the technology landscape.',
        LEVEL_4: 'Sponsorship is comprehensive across the entire C-level to include marketing, finance, operations, HR, and more, and extends down to all levels of management. They comprehensively and consistently set the tone for a culture of experimentation and innovation within teams. Error budgets for software services are accepted and understood at the highest level (CEO), and a culture of blameless postmortems is fostered throughout the IT organization.<br>Project teams operate in an environment of transparency and open information sharing and enjoy enough decision-making autonomy to be able to experiment ad hoc without having to ask for permission or having to wait for resources to be provisioned. (Data governance and cost control are now a function of automation, not manual managerial process.) Failures are celebrated for the valuable lessons that the team has learned and will be shared with the wider business for posterity. An individual’s mistake is interpreted as a collective or systematic failure that must be addressed as a whole, not by reprimanding the individual.',
    },
    DIMENSION_SCALE: {
        LEVEL_0: 'Use of managed or serverless cloud services is limited. Instead, a continued reliance on self-managed, long-lived virtual machines (VMs) provides a familiar computing platform at the risk of entropy (“config drift”), making consistent and secure operations increasingly hard over time. Because there is more to be managed, there is also more to be measured, increasing the burden of collecting quality, high-frequency events and metrics.<br>Changes to application code and environment configuration are reviewed and controlled manually, for example, by a change advisory board. They are often considered high risk and deployed infrequently, measured in weeks or even months.<br>The provisioning of cloud resources is performed manually via the GCP Web Console or command-line interface (CLI). Infrastructure automation tools like Deployment Manager or Hashicorp’s Terraform are not leveraged. While the use of the GCP Web Console or CLI is already a great improvement over the manual process of racking and stacking servers, it only marks the beginning of the cloud’s potential for automation.',
        LEVEL_1: 'Use of managed or serverless cloud services is limited. Instead, a continued reliance on self-managed, long-lived virtual machines (VMs) provides a familiar computing platform at the risk of entropy (“config drift”), making consistent and secure operations increasingly hard over time. Because there is more to be managed, there is also more to be measured, increasing the burden of collecting quality, high-frequency events and metrics.<br>Changes to application code and environment configuration are reviewed and controlled manually, for example, by a change advisory board. They are often considered high risk and deployed infrequently, measured in weeks or even months.<br>The provisioning of cloud resources is performed manually via the GCP Web Console or command-line interface (CLI). Infrastructure automation tools like Deployment Manager or Hashicorp’s Terraform are not leveraged. While the use of the GCP Web Console or CLI is already a great improvement over the manual process of racking and stacking servers, it only marks the beginning of the cloud’s potential for automation.',
        LEVEL_2: 'VMs are designed to be immutable, thereby greatly reducing the scope for change to a system. Environment configuration is baked into versioned VM images, and stateful and stateless workloads are cleanly separated to allow for elastic horizontal scaling. Inside the VM, configuration values and keys are stored only in-memory, and outside the VM only in discrete services like the GCP metadata service, Cloud Key Management Service, or Hashicorp Vault.<br>The risk of change is considered to be mostly moderate. Deployments to production environments are executed programmatically, but triggered manually, and can be easily rolled back if necessary.<br>Application teams go beyond basic monitoring and logging, making use of application performance monitoring (APM), either through Stackdriver or through a third-party solution to deliver near real-time insights into service health under real production loads, 24/7.<br>The provisioning of GCP projects includes all associated configurations (like VPC networking, billing account, and Cloud Identity and Access Management policies) and is performed programmatically via Deployment Manager or Hashicorp Terraform, based on a limited set of inputs like cost center, data sensitivity, team ownership, and dependency with services hosted in other GCP projects.',
        LEVEL_3: 'VMs are designed to be immutable, thereby greatly reducing the scope for change to a system. Environment configuration is baked into versioned VM images, and stateful and stateless workloads are cleanly separated to allow for elastic horizontal scaling. Inside the VM, configuration values and keys are stored only in-memory, and outside the VM only in discrete services like the GCP metadata service, Cloud Key Management Service, or Hashicorp Vault.<br>The risk of change is considered to be mostly moderate. Deployments to production environments are executed programmatically, but triggered manually, and can be easily rolled back if necessary.<br>Application teams go beyond basic monitoring and logging, making use of application performance monitoring (APM), either through Stackdriver or through a third-party solution to deliver near real-time insights into service health under real production loads, 24/7.<br>The provisioning of GCP projects includes all associated configurations (like VPC networking, billing account, and Cloud Identity and Access Management policies) and is performed programmatically via Deployment Manager or Hashicorp Terraform, based on a limited set of inputs like cost center, data sensitivity, team ownership, and dependency with services hosted in other GCP projects.',
        LEVEL_4: 'Production VMs allow shell access in break-glass scenarios for debugging purposes only. Self-managed services are replaced with managed equivalents (for example, Cloud SQL, Cloud Memorystore) or serverless/SaaS alternatives, where feasible, to minimize the operations overhead of IaaS-based services.<br>The risk of change is considered to be low. Deployments to production environments are executed programmatically and automatically, using phased strategies (canary, blue/green, and so on).<br>Logging and monitoring are comprehensive and cover every service-level indicator that underpins each service-level objective.<br>All cloud resources are provisioned programmatically via Deployment Manager, Hashicorp Terraform, or directly via GCP’s RESTful APIs. Entire production environments can be (re)created within minutes in another zone or region.',
    },
    DIMENSION_SECURE: {
        LEVEL_0: 'User identities manifest themselves as Google Cloud Identity accounts under an organization domain name, and all consumer accounts for Google Analytics, Adwords, Play, YouTube, etc. are now under the control of the enterprise. These identities are not yet synchronized with the organization’s central identity solution, e.g., Microsoft Active Directory, and therefore not governed by a single source of truth.<br>Cloud IAM policies predominantly rely on the convenience of project-level Primitive Roles (Owner, Editor, Viewer) rather than following the principle of least privilege. Default permissions allow for any user to create GCP projects and billing accounts. Cloud IAM permissions are not continuously monitored with tools like Forseti Security, and the GCP Admin Activity and Data Access logs are not systematically audited. Service accounts can be created freely, and private keys for service accounts are not automatically rotated.<br>An overreliance is placed on the network to establish a secure logical perimeter around all hosted data and applications: firewalls are used as a critical component to restrict access based on contextual information like the IP address of the client or the port of the application. Communication between clouds and data centers is encrypted using virtual private network (VPN) tunnels by default, with little regard to the efficacy of inter-application encryption using Transport Layer Security (TLS). VPC Service Controls are enforced around fully managed GCP services like Cloud Storage and BigQuery as a matter of principled policy, rather than based on the sensitivity of the data.',
        LEVEL_1: 'User identities manifest themselves as Google Cloud Identity accounts under an organization domain name, and all consumer accounts for Google Analytics, Adwords, Play, YouTube, etc. are now under the control of the enterprise. These identities are not yet synchronized with the organization’s central identity solution, e.g., Microsoft Active Directory, and therefore not governed by a single source of truth.<br>Cloud IAM policies predominantly rely on the convenience of project-level Primitive Roles (Owner, Editor, Viewer) rather than following the principle of least privilege. Default permissions allow for any user to create GCP projects and billing accounts. Cloud IAM permissions are not continuously monitored with tools like Forseti Security, and the GCP Admin Activity and Data Access logs are not systematically audited. Service accounts can be created freely, and private keys for service accounts are not automatically rotated.<br>An overreliance is placed on the network to establish a secure logical perimeter around all hosted data and applications: firewalls are used as a critical component to restrict access based on contextual information like the IP address of the client or the port of the application. Communication between clouds and data centers is encrypted using virtual private network (VPN) tunnels by default, with little regard to the efficacy of inter-application encryption using Transport Layer Security (TLS). VPC Service Controls are enforced around fully managed GCP services like Cloud Storage and BigQuery as a matter of principled policy, rather than based on the sensitivity of the data.',
        LEVEL_2: 'User identities are synchronized to Google Cloud Identity from a directory service like Active Directory or OpenLDAP, thereby maintaining a single source of truth and a simpler governance model. Users are authenticated either with the same synchronized password or via a third-party single sign-on (SSO) service. 100% of all user accounts use two-step verification (e.g., SMS or code generator app) to defend against phishing attacks, albeit not with a hardware security key.<br>Cloud IAM policies reference a much more granular set of predefined roles, rather than the coarse primitive roles. The Project Creator and Billing Account Creator roles have been removed from the organization level to ensure a basic degree of cloud resource governance.<br>The network-based security perimeter (VPC) is augmented by additional security layers that protect individual services, for example, via Google’s global Cloud Load Balancing with TLS configured, Cloud Identity-Aware Proxy, and Cloud Armor. This, in turn, lowers the risk profile of exposing a private service to the public internet.',
        LEVEL_3: 'User identities are synchronized to Google Cloud Identity from a directory service like Active Directory or OpenLDAP, thereby maintaining a single source of truth and a simpler governance model. Users are authenticated either with the same synchronized password or via a third-party single sign-on (SSO) service. 100% of all user accounts use two-step verification (e.g., SMS or code generator app) to defend against phishing attacks, albeit not with a hardware security key.<br>Cloud IAM policies reference a much more granular set of predefined roles, rather than the coarse primitive roles. The Project Creator and Billing Account Creator roles have been removed from the organization level to ensure a basic degree of cloud resource governance.<br>The network-based security perimeter (VPC) is augmented by additional security layers that protect individual services, for example, via Google’s global Cloud Load Balancing with TLS configured, Cloud Identity-Aware Proxy, and Cloud Armor. This, in turn, lowers the risk profile of exposing a private service to the public internet.',
        LEVEL_4: 'All service-to-service communication is authenticated and authorized. Little trust is placed in the circumstance that they might share the same virtual private cloud (VPC) and/or VPN. For that same reason, internal firewall rules don’t allow for specific IP addresses or ranges but rather for specific service accounts.<br>A comprehensive understanding of the contents of all your data stores provides the threat profiles for which you can design your security and data governance models, considering scenarios of both unauthorized and inappropriate access.<br>100% of all user accounts use a hardware security key as their second factor to effectively defend against phishing attacks. SMS and code generator apps are understood to be insufficiently safe.<br>GCP Admin Activity and Data Access logs are regularly audited through Stackdriver and automatic alerts have been configured to watch for patterns that match your threat profile. Cloud IAM permissions and firewall rules are continuously monitored and corrected with tools like Forseti Security.',
    },
}
